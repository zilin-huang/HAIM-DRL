...
class RecorderEnv(Wrapper):
    ...
    def on_episode_start(self):
        ...
        self.user_data["disturbance"] = []
        self.user_data["total_disturbance_cost"] = []
    ...
    def on_episode_step(self, r, info):
        ...
        if info:
            ...
            self.user_data["disturbance"].append(1 if info["disturbance"] else 0)
            self.user_data["total_disturbance_cost"].append(info["disturbance_cost"])
    ...
    def get_episode_result(self):
        ...
        ret["episode_disturbance"] = sum(self.user_data["disturbance"]) if ep_len > 0 else 0.0
        ret["episode_disturbance_cost"] = sum(self.user_data["total_disturbance_cost"]) if ep_len > 0 else 0.0
