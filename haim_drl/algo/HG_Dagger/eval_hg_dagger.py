...
import numpy as np
import pandas as pd
from haim_drl.algo.HG_Dagger.model import Ensemble
from haim_drl.utils.config import baseline_eval_config
from haim_drl.utils.eval_IWR_HG_Dagger import pretty_print, RecorderEnv
...
if __name__ == "__main__":
    ckpt_path = '/home/zilin/code/HAIM-DRL/haim_drl/run_baselines/hg_dagger_lr_0.0005_bs_256_sgd_iter_1000_iter_batch_5000/2023-7-15-22-51-51/hg_dagger_models/model_4.pth'

    evaluate_once(ckpt_path, "hg_dagger_model_4_eval_results", "hg_dagger")
